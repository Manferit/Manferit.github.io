...
try {
    $sql = "SELECT * FROM productos WHERE categoria = 'Salsas' ORDER BY fecha_registro DESC";;
...
<section class="hero">
    <div class="hero-content">
        <h1>salsas
        <p>Explora nuestra selección de salsas frescas y delisiosas</p>
    </div>
</section>
    ...
    <section class="featured-products">
        ...
        <div class="product-grid">
            <?php if (!empty($productos)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p class="no-products">No hay salsas actualmente disponibles </p>
            <?php endif; ?>
        </div>
    </section>
</main>
