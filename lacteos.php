...
try {
    $sql = "SELECT * FROM productos WHERE categoria = 'Lacteos' ORDER BY fecha_registro DESC";;
...
<section class="hero">
    <div class="hero-content">
        <h1>Lacteos
        <p>Explora nuestra selección de lacteos frescos y deliciosos.</p>
    </div>
</section>
    ...
    <section class="featured-products">
        ...
        <div class="product-grid">
            <?php if (!empty($productos)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p class="no-products">No hay lacteos disponibles actualmente.</p>
            <?php endif; ?>
        </div>
    </section>
</main>
